...
<body style="background-color: violet; height: 800px;">
	...
	<?php
		$sql="SELECT * FROM `student registration` where username='$_SESSION[login_user]';";
	...
	<?php
		if(isset($_POST['submit']))
		{
			...
			$sql1="UPDATE `student registration` SET `firstname`='$first',`lastname`='$last',`email`='$email',`phoneNo`=$phone,`password`='$password', `pic`='$pic' WHERE `username`='".$_SESSION['login_user']."';";
