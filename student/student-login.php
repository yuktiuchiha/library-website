...
<body>
	...
	<section width: 1355px;>
		<div class="login-img" style="width: 1355px; background-repeat: no-repeat;">
			<br>
			<div class="box1">
				<br>
	...
	<?php
		...
		{
			$count=0;
			$res=mysqli_query($db,"SELECT * FROM `student registration` WHERE username='$_POST[username]' && password='$_POST[password]';");
