...
<?php
	...
	{
		$count=0;
		$sql="SELECT username from `student registration`";
		...
		if($count==0)
		{
		mysqli_query($db,"INSERT INTO `student registration` VALUES('$_POST[firstname]', '$_POST[lastname]', '$_POST[email]', '$_POST[phoneNo]', '$_POST[username]', '$_POST[password]', 'u1.png');");
?>
