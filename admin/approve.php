...
<div class="container"> 
	<h3 style="text-align: center; font-size: 40px;"><b><u>APPROVE REQUEST</u></b></h3>
<br><br>
	<center><form class="Approve" action="" method="post">
		<input type="yext" name="approve" placeholder="approve or not" required="" class="form-control"><br>
...
<?php
	if(isset($_POST['submit']))
	{
		...
		mysqli_query($db,"UPDATE `issue-book` SET `issue`='$_POST[issue]',`approve`='$_POST[approve]',`dueon`='$_POST[return]' WHERE username='$_SESSION[name]' AND bid='$_SESSION[bid]';");
