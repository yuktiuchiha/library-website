...
<meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <?php
 	$sql1=mysqli_query($db,"SELECT `student registration`.pic,message.username from `student registration` inner join message on `student registration`.username=message.username group by username order by message.status;");
 ?>
 <!-----   left box   --------->
 	...
 	<div class="left_box2">
 		...
 		<div class="list">
 			<?php
 				...
 				{
 					echo "<tr>";
 						echo "<td>"; echo "<img class='img-circle profile_img' height=60 width=60 src='img/".$res1['pic']."'> ";
 						echo "</td>";
...
/*--------------- if submit1 is pressed --------*/
 			...
 			if(isset($_POST['submit1']))
 			{
	 			...
	 			$res=mysqli_query($db,"SELECT * from `message` where username='$_SESSION[login_user]' and receiver='$_SESSION[username]' or username='$_POST[username]' ;");
			...
			<!------   student    -------->
	 		...
	 		<?php
 					...
 					?>
 						<center>
 						<img src="img/tenor.gif" style="margin-top: 35px; height: 80%; width: 90%; border-radius: 50%;"></center>
 					<?php	
