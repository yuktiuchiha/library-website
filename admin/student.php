...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<center><h2><b><u>LIST OF STUDENTS</u></b></h2></center>
	<br><br>
	...
	{
		$q=mysqli_query($db,"SELECT firstname,lastname,email,phoneNo,username FROM `student registration` where `username` like '%$_POST[search]%' ");
		
		if(mysqli_num_rows($q)==0)
		{
			echo"<b><center><h2>sorry no match found...try again</h2></center></b>";
		}
		else
		{
	...
	else
	{
		...
		$res=mysqli_query($db,"SELECT firstname,lastname,email,phoneNo,username FROM `student registration`;");
